                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Button className="bg-[#14b8a6] hover:bg-[#14b8a6]/90" asChild>
                        <a
                          href={`https://wa.me/919690707002?text=Hi, I want to book a bus from ${route.from} to ${route.to}`}
                          target="_blank"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-3 border-t border-slate-100">
                      ...
                      <Button className="w-full bg-[#f59e0b] hover:bg-[#f59e0b]/90" asChild>
                        <a
                          href={`https://wa.me/919690707002?text=Hi, I want to book a ${cab.type} cab`}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          Book
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  ...
                  <Button size="lg" className="bg-[#14b8a6] hover:bg-[#14b8a6]/90" asChild>
                    <a
                      href="https://wa.me/919690707002?text=Hi, I want to enquire about helicopter charter services"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Enquire Now
