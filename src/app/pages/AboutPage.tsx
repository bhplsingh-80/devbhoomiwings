    ...
    <div className="min-h-screen bg-[#fafaf9]">
      ...
      <main className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-[#0f172a] mb-6">About DEVBHOOMI TRAVELMOUR WINGS INDIA PRIVATE LIMITED</h1>
          <div className="space-y-6 text-[#64748b]">
            <p className="text-lg">
              DEVBHOOMI TRAVELMOUR WINGS INDIA PRIVATE LIMITED is a government-authorised travel company, established in 2018 
            ...
            <p>
              ...
              <strong>Contact:</strong> View Details: +91 93113 44461, Cab Booking: +91 93113 44462, Tech Support: +91 6395734224<br />
              <strong>Email:</strong> Admin: sales@devbhoomiwings.com, Support: bhupalsingh@devbhoomiwings.com<br />
              <strong>Director:</strong> Bhupal Singh - +91 93113 44461<br />
